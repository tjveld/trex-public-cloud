locals {
  ...
  # FortiGate's port2 static IP - the next_hop_in_ip_address for
  # spoke_1_subnets' VirtualAppliance routes.
  fgt_port2_ip = cidrhost(var.hub_subnets["firewall"].address_prefixes[0], 4)
}
